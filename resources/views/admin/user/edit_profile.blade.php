...
@section('content')
    <div class="position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg profile-setting-img">
            <img src="/theme/admins/velzon/assets/images/profile-bg.jpg" class="profile-wid-img" alt="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="phone" class="form-control"
                                                id="phonenumberInput" value="{{ $user->phone }}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="password" class="form-control" id="emailInput"
                                                value="{{ $user->password }}">
                                        </div>
                                    </div>
                                    <!--end col-->
...
@section('script-libs')
    ...
    <script src="/theme/admins/velzon/assets/js/pages/profile-setting.init.js"></script>
@endsection
