...
<form action="{{ route('post.update', $post->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row mb-3">
        ...
        <div class="col-lg-9">
            <input type="text" class="form-control" id="nameInput" name="title"
             value="{{$post->title}}" placeholder="Enter your title">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-lg-3">
    ...
    <div class="row mb-3">
        ...
        <div class="col-lg-9 form-switch-{{ $color }}">
            <input type="checkbox" class="form-check-input" @checked($post->$key) id="" value="1" name="{{$key}}" >
