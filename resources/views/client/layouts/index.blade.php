            ...
            <div class="row">
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        ...
                        <div class="card-body">
                            <h3 class="h4 mb-3"><a class="post-title" href="{{route('post_showDetail',$item)}}"> {{$item->title}} </a></h3>
                ...
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card mb-4">
                        <div class="card-body d-flex">
                            <img class="card-img-sm" src="{{ \Storage::url($item->img_thumb) }}">
                            <div class="ml-3">
                                <h4><a href="{{route('post_showDetail',$item)}}" class="post-title"> {{$item->title}} </a>
                                </h4>
                ...
                <div class="col-lg-8  mb-5 mb-lg-0">
                    ...
                    <article class="card mb-4">
                        <div class="post-slider">
                            <img src="{{\Storage::url($item->img_thumb)}}" class="card-img-top"
                                alt="post-thumb">
                           
                        </div>
                        <div class="card-body">
                            <h3 class="mb-3"><a class="post-title" href="{{route('post_showDetail',$item)}}"> {{$item->title}} </a></h3>
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
